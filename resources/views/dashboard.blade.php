...
<div class="max-w-5xl mx-auto px-4 pt-6 pb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-stone-100 flex items-center gap-3">
            ...
            <div class="min-w-0">
                <div class="text-2xl font-bold text-emerald-700 leading-tight">Rp {{ number_format($todayRevenue, 0, ',', '.') }}</div>
        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-stone-100 flex items-center gap-3">
            ...
            <div class="min-w-0">
                <div class="text-2xl font-bold text-emerald-700 leading-tight">{{ $gradeAToday }}</div>
        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-stone-100 flex items-center gap-3">
            ...
            <div class="min-w-0">
                <div class="text-2xl font-bold text-red-500 leading-tight">{{ $deadRate }}%</div>
