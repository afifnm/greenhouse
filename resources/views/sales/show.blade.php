...
<div class="max-w-2xl mx-auto px-4 pt-6 pb-8">
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-stone-100 mb-4">
        <div class="flex items-center justify-between">
            ...
            @if($sale->greenhouse)
                <a href="{{ route('sales.greenhouse', $sale->greenhouse) }}"
            @else
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-stone-100">
        ...
        <!-- Actions -->
        <div class="mt-6 pt-6 border-t border-dashed border-stone-200 flex justify-end gap-3">
            <a href="{{ route('sales.print', $sale) }}" target="_blank"
                class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-stone-100 hover:bg-stone-200 text-stone-700 text-sm font-semibold transition-colors">
